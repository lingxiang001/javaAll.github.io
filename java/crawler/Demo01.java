...
public class Demo01 extends BreadthCrawler {
    static int count=0;
    public Demo01(String crawlPath, boolean autoParse) {
    ...
    */
    ...
    public void visit(Page page, CrawlDatums next) {
        ...
        if (page.matchUrl("http://blog.csdn.net/.*/article/details/.*")) {
           ...
           // String content=page.select("blockquote").text();
            String taglib=page.select("span[class=link_categories]>a").text();
            System.out.println("count:="+(++count));
            System.out.println("title:" + title + "\tauthor:" + author);
            System.out.println("talib:"+taglib);
        }
    }

    public static void main(String[] args) throws Exception {
        Demo01 crawler = new Demo01("crawler", true);
